export const galleryData: { [key: string]: string[] } = {
  ...
  'Carpintaria Residencial': [
    ...
    '/images/Carpintaria Residencial/servicos_-_carpintaria_nova_1.jpg',
  ],
  ...
  'Pintura de Interiores Portfolio': [
    '/images/Pintura de Interiores/pintura_de_interiores_1.jpg',
    '/images/Pintura de Interiores/pintura_de_interiores_2.jpg',
